...
5. **Run the project's type-check, lint, and format commands** (check CLAUDE.md or package.json scripts for the correct invocations). Fix any errors introduced by the removals before finishing.
